...
const Contact = () => {
  ...
  return (
    <section id="contact" ref={ref} className="py-24 bg-gray-900">
      <motion.div
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Open to senior engineering roles in AI/ML and backend development.
        ...
        >
          {contactLinks.map((link) => (
            <a
              ...
              className="flex items-center gap-4 p-6 bg-gray-800/50 border border-gray-700/50 rounded-xl hover:border-blue-500/30 transition-all duration-300 group"
            >
